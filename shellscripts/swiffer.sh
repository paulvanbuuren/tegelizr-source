# sh '/home/paulvanb/webapps/tegelizr/shellscripts/swiffer.sh'

echo "Swiffer hiero"

find /home/paulvanb/webapps/tegelizr/ -type f -name "*van-harte-gefeliciteerd*" -exec rm -vf {} \;
find /home/paulvanb/webapps/tegelizr/ -type f -name "*hartelijk-gefeliciteerd*" -exec rm -vf {} \;
find /home/paulvanb/webapps/tegelizr/ -type f -name "*fijne-samenwerking*" -exec rm -vf {} \;
find /home/paulvanb/webapps/tegelizr/ -type f -name "*gefeliciteerd-met-je-verjaardag*" -exec rm -vf {} \;
find /home/paulvanb/webapps/tegelizr/ -type f -name "*woordvoerder-oeleh*" -exec rm -vf {} \;
find /home/paulvanb/webapps/tegelizr/ -type f -name "*woordvoerder-ouleh*" -exec rm -vf {} \;
find /home/paulvanb/webapps/tegelizr/ -type f -name "*gaat-met-pensioen*" -exec rm -vf {} \;
...
find /home/paulvanb/webapps/tegelizr/ -type f -name "*snicker*" -exec rm -vf {} \;
