...
///
// Tegelizr - translation-en.inc.php
// ----------------------------------------------------------------------------------
// English translations for strings
// ----------------------------------------------------------------------------------
...
define('_SITE_TITLE',               'Online tegeltjes bakken');
define('_FORM_DESCRIPTION',         'Wat is jouw tegeltjeswijsheid? Voer hier je tekst in. Een dag geen tegeltjes gemaakt is een dag niet geleefd!');
define('_LINK_BACK',             'Bak een tegeltje!');
