...
function wbvb_d2e_socialbuttons($thelink = 'thelink', $thetitle = 'thetitle', $summary = 'summmary') {
    ...
    if ( $thelink ) {
        return '<ul class="social-media">
            <li><a href="https://twitter.com/share?url=' . $thelink . '&via=paulvanbuuren&text=' . $thetitle . '" class="twitter" data-url="' . $thelink . '" data-text="' . $thetitle . '" data-via="@paulvanbuuren"' . $popup . '><span>Tweet</span></a></li>
            <li><a class="facebook" href="https://www.facebook.com/sharer/sharer.php?u=' . $thelink . '&t=' . $thetitle . '"' . $popup . '><span>Facebook</span></a></li>
<!--            <li><a class="googleplus" href="https://plus.google.com/share?url=' . $thelink . '&t=' . $thetitle . '"' . $popup . '><span>Google+</span></a></li>-->
            <li><a class="linkedin" href="http://www.linkedin.com/shareArticle?mini=true&url=' . $thelink . '&title=' . $thetitle . '&summary=' . $summary . '&source=' . $sitetitle . '"' . $popup . '><span>LinkedIn</span></a></li>
            </ul>';    
    }
}
    ...
    <g id="wbvb-logo" sketch:type="MSArtboardGroup">
      <g id="WBVB-logo" sketch:type="MSLayerGroup" transform="translate(16.000000, 7.000000)">
        ...
        <g id="tekst" fill="#FFFFFF" sketch:type="MSShapeGroup">
          <path d="M141.2 228.3 L125.4 251.7 L116.3 245 L133.6 222.8 L106 214.7 L109.6 203.8 L136.5 213.8 L135.6 184.9 L147 184.9 L146.1 213.8 L172.7 203.8 L176.4 214.7 L148.8 222.8 L166 245 L157.1 251.7 L141.2 228.3 Z" id="ster-links"/>
          <path d="M677.8 229.6 L662.1 252.9 L653 246.2 L670.2 224.1 L642.7 216 L646.3 205.1 L673.1 215 L672.2 186.2 L683.6 186.2 L682.7 215 L709.4 205.1 L713 216 L685.5 224.1 L702.7 246.2 L693.8 252.9 L677.8 229.6 Z" id="ster-rechts"/>
